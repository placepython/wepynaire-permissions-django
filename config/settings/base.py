"""
Django settings for WePynaire project.
"""
...
ADMINS = [
    ("Thierry Chappuis", "thierry-chappuis@example.com"),
]
MANAGERS = ADMINS

# Email configuration
EMAIL_SUBJECT_PREFIX = "[WePynaire] "
DEFAULT_FROM_EMAIL = "thierry-chappuis@example.com"
